            ...
            <div class="card card-table">
                <div class="card-body">
                    <div class="title-header option-title">
                        <h5>Gift Card List</h5>
                        <div class="right-options">
                            <ul>
                                <li>
                                    <a class="btn btn-solid" href="<?php echo e(route('giftcards.create')); ?>">Create Gift Card</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\30Dec-curryleaf\resources\views/giftcards/cardslist.blade.php ENDPATH**/ ?>